...
const HELP = [
  ...
  '  shucky find [query]                    search registered sources + registries (alias: search)',
...
module.exports = { runCli, parseArgs, HELP, cmdInstall, cmdScan, cmdList, cmdSource, cmdRemove, cmdUpdate, gateDecision };
